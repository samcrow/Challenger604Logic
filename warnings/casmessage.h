...
public:
    ...
    /**
      @brief Determine if this message should be ignored when the aircraft is taking off.

      The criteria for taking off are explained in the Aural and Visual Warning document
      on pages 16-17.
    ...
    /**
      @brief Determine if this message should be ignored when the aircraft is landing.

      The criteria for landing are explained in the Aural and Visual Warning document
      on pages 16-17.
